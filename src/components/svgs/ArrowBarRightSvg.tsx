...
export default function ArrowBarRightSvg ({color = "black", width = "1rem", height = "1rem"}: Props) {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" width={width} height={height} fill={color} className="bi bi-arrow-bar-right" viewBox="0 0 16 16">
